...
function noAds() {
    ...
    let adContainers = document.getElementsByClassName("adContainer"),
        ...
        paypalButton = `<form action="https://www.paypal.com/donate" method="post" target="_top"><input type="hidden" name="hosted_button_id" value="C5CLJ64PC83ES" /><input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" /><img alt="" border="0" src="https://www.paypal.com/en_US/i/scr/pixel.gif" width="1" height="1" /></form>`,
        paypalMessage = `<strong>No ads? No problem!</strong> You can support the Master Nest by <a href="https://www.paypal.com/donate/?hosted_button_id=C5CLJ64PC83ES">donating through PayPal</a>. Thanks for visiting us!`;
